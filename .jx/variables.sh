...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-context/master/18'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-context:0.4.0'
